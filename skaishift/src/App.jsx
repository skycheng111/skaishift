...
const AI_TOOLS = [
  ...
  { name:"Higgsfield",      cat:"Video",       desc:"AI video generation platform known for cinematic, photorealistic output. Popular for real estate walkthroughs, lifestyle content, and commercial video. Integrates with Claude for script-to-scene workflows.", url:"https://higgsfield.ai" },"Google's natively multimodal model from I/O 2026. Takes text, images, audio, and video as input and generates cinematic video output. Available in Google Flow.", url:"https://labs.google/flow" },
