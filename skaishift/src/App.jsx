...
const LEARN_SECTIONS = [
  ...
  },
  {
    ...
    content:[
      ...
      {q:"What is fine-tuning?",a:"Fine-tuning is the process of taking a pre-trained model (like Claude Sonnet 5 or GPT-5.6 Terra) and training it further on your specific data to make it better at your specific task. A customer service model fine-tuned on your company's past support tickets will outperform a generic model on your use case. Fine-tuning is expensive and complex — most businesses get better results from good prompting and RAG before investing in fine-tuning."},
  ...
  },
  {
    ...
    content:[
      ...
      {q:"DeepSeek",a:"DeepSeek is a Chinese AI company that released highly capable open-source models that match or beat frontier US models at a fraction of the cost. DeepSeek R1's release in January 2025 caused significant market disruption. The latest is DeepSeek V4 Pro ($0.43/$0.87 per MTok — nearly 12× cheaper than GPT-5.6 Sol). Their efficiency innovations have been widely adopted. Important caveat: DeepSeek models send data to servers in China — regulated industries and privacy-conscious users should self-host the open weights rather than using their API."},
    ]
  },
  {
    id:"agentic",
  ...
  },
  {
    ...
    content:[
      ...
      {q:"Open-source vs. closed-source",a:"Closed-source models (GPT-5.6, Claude, Gemini) are proprietary — you access them via API and pay per use, but you can't see or modify the underlying model. Open-source models (Llama, Mistral, DeepSeek) are publicly available — you can download them, run them locally, modify them, and build on them without licensing fees or API costs."},
      ...
      {q:"Foundation model",a:"A large AI model trained on broad data that can be adapted to many different tasks. GPT-5.6, Claude Sonnet 5, and Gemini are foundation models. They're called 'foundation' because they serve as the base for building more specialized applications — fine-tuned versions, RAG systems, agents, etc."},
...
const AI_TOOLS = [
  ...
  { name:"OpenCode",        cat:"Coding",      desc:"Most-adopted open-source coding agent — 160K+ GitHub stars, 7.5M monthly active developers. Model-agnostic: works with Claude, GPT, Gemini, DeepSeek, and local models via Ollama. Unique LSP integration feeds compiler diagnostics back to the model.", url:"https://opencode.ai" },
  ...
  // Image
  { name:"Midjourney V8.1", cat:"Image",       desc:"Best-in-class AI image generation. V8.1 became the default on June 10, 2026 — 5× faster generation, native 2K HD images, improved text rendering, and better prompt adherence. Built on a fully rewritten codebase.", url:"https://midjourney.com" },
...
// ── EARN PAGE ─────────────────────────────────────────────────────────────────
const EARN_STREAMS = [
  { n:"AI Training & Evaluation Work", range:"$500–$5K/mo", diff:"Easy", desc:"Get paid by AI companies to rate outputs, build training examples, and red-team models. Platforms: Scale AI, Outlier, Remotasks, Appen. General tasks pay $15–$40/hr. Specialized domains (law, medicine, coding, finance) reach $60–$100/hr. Zero barrier to entry, fully remote, flexible hours.", steps:["Sign up for Scale AI, Outlier, and Remotasks — each has different project types","Complete onboarding tasks honestly to unlock higher-paying specialized queues","Specialize in your background (medical, legal, financial) for 2-3× the base rate","Stack multiple platforms for consistent income while skills build toward higher-earning streams"] },
  { n:"AI Freelancing on Gig Platforms", range:"$1K–$8K/mo", diff:"Easy", desc:"Offer AI-specific services on Fiverr and Upwork: chatbot setup, AI agent builds, workflow automation, AI video creation, custom GPT builds. Upwork's 2026 report found AI freelancers earn 34% more/hr than non-AI freelancers. Lowest barrier to entry — good for getting first clients fast.", steps:["Pick 1-2 specific AI services you can deliver reliably","Create a Fiverr or Upwork profile with clear deliverables and turnaround time","Build 3 portfolio samples before launching","Start at competitive pricing to build reviews, raise rates after 10+ positive reviews"] },
  { n:"AI Avatar & Voice Production", range:"$1K–$8K/mo", diff:"Easy", desc:"Create branded AI presenters, voiceovers, and video spokespeople for businesses using ElevenLabs, HeyGen, and Synthesia. HeyGen alone has 40K+ business customers needing AI sales videos, training content, and explainers with consistent branded voices. Completely distinct from general video production — this is a repeatable productized service.", steps:["Learn ElevenLabs voice cloning and HeyGen avatar creation — both have free tiers","Build 3 sample videos: a sales explainer, a training module, and a product demo","Target SaaS companies, real estate agents, and e-commerce brands","Charge $200–$800 per video or $1K–$3K/month for ongoing content"] },
  { n:"Selling AI Digital Products", range:"$500–$10K/mo", diff:"Easy", desc:"Create and sell AI-powered digital products: prompt packs, Midjourney V8.1 style guides, n8n workflow templates, Claude/GPT system prompt libraries, AI art presets, Higgsfield video templates. Once created, earns passively. Sell on Gumroad, Etsy, or your own site.", steps:["Identify a specific niche (real estate video, e-commerce ads, social content)","Create a high-value prompt pack or workflow template they'd pay for","List on Gumroad or Etsy with clear before/after examples","Drive traffic through short-form content showing the product in action"] },
  { n:"AI Content Creation", range:"$2K–$10K/mo", diff:"Easy", desc:"Use AI tools to produce content at scale for clients. Important 2026 reality: commodity content rates fell 13% on Upwork as AI flooded generic work. Specialize in one industry (legal, SaaS, finance) to command premium rates — domain expertise now beats volume.", steps:["Pick 2-3 content types you'll specialize in","Build a portfolio of 5 samples using AI tools","Price per deliverable or on retainer","Automate your own workflow to increase margins"] },
  { n:"Vibe Coding for Clients", range:"$1K–$10K/project", diff:"Medium", desc:"Use Claude Code, Cursor, and Windsurf to build functional web apps, internal tools, and dashboards for non-technical business owners. Non-developers can now deliver projects that previously required a full-stack developer. Distinct from AI SaaS (you own the product) — this is client work where they own it.", steps:["Learn Claude Code or Cursor and build 2 demo projects (a dashboard + a booking tool)","Position yourself as a \'vibe coder\' — fast, affordable, no traditional dev overhead","Target small business owners, coaches, and local services on Instagram or LinkedIn","Charge $500–$2K for simple tools, $3K–$10K for multi-page apps with integrations"] },
  { n:"AI-Powered Lead Generation Service", range:"$2K–$12K/mo", diff:"Medium", desc:"Use Clay 2.0, Apollo, and AI to build hyper-personalized outreach campaigns for clients. Scrape leads, enrich with AI-written research, generate personalized first lines at scale. Clients pay for booked meetings, not lists. AI-enabled professional services including lead gen grew 72% YoY (Upwork 2026).", steps:["Learn Clay 2.0 — it combines data enrichment + AI personalization in one workflow","Build a sample campaign for a niche (e.g. SaaS companies with 10–50 employees)","Offer a paid pilot: 500 enriched leads with AI-personalized email lines for $750","Scale to retainers: $2K–$5K/month for ongoing lead flow and booked meetings"] },
  { n:"AI Video Production Agency", range:"$2K–$15K/mo", diff:"Medium", desc:"Produce short-form video ads, social content, and brand videos using Runway Gen-4.5, Veo 3.1, Kling 3.0, and Higgsfield. Demand for AI video creators grew 66% YoY (Upwork 2026). Clients pay for output — not your tools or hours. Biggest opportunity: UGC-style ad creatives for e-commerce brands.", steps:["Learn Runway Gen-4.5 and Higgsfield — both have free tiers to practice","Build a portfolio of 5 sample videos across different styles","Target e-commerce brands and marketing agencies on Instagram/LinkedIn","Charge $300–$1,500 per video or $2K–$5K/month for a content retainer"] },
  { n:"AI Automation Agency", range:"$3K–$25K/mo", diff:"Medium", desc:"Build custom AI workflows and agents for businesses — lead qualification, support bots, document processing, email automation. 2026 market: single-agent builds cost clients $1.5K–$5K setup + $300–$800/month; multi-agent stacks $5K–$25K setup + $1K–$3K/month. Tools: n8n (best margins, self-hostable), Make.com, Claude API. Target: SMBs in one vertical.", steps:["Pick one industry and one painful repetitive process","Build 1 working demo using n8n (self-hostable = better margins than Make)","Cold outreach to 20 businesses per week with ROI-focused pitch","Charge $1.5K–$5K setup + $300–$800/month retainer per client"] },
  ...
  { n:"AI Consulting", range:"$5K–$30K/mo", diff:"Medium", desc:"Help businesses develop an AI strategy — what tools to use, what to automate, how to train staff. 2026 confirmed rates: $80–$150/hr US-based, $40–$100/hr on Upwork. AI-enabled professional services grew 72% YoY (Upwork 2026). Requires credibility and case studies.", steps:["Define your consulting niche (marketing, ops, HR, etc.)","Do 3 free or discounted engagements to build case studies","Package: AI Audit ($2K), Strategy ($5K), Implementation ($15K+)","Market through LinkedIn content and speaking"] },
  { n:"AI Agent Deployment", range:"$5K–$25K/project", diff:"Hard", desc:"Build and deploy production AI agents — systems with tools, memory, and multi-step reasoning that replace human workflows. 2026 market rates: single-purpose agents $1.5K–$5K build + $300–$800/month; multi-agent orchestrations $5K–$25K build + $1K–$3K/month. Tools: Claude API, GPT-5.6 function calling, Grok 4.5 for coding agents.", steps:["Learn Claude API or GPT-5.6 function calling and build 2 working agent demos","Target one use case: lead research, support deflection, internal knowledge agents","Charge $1.5K–$5K to build, plus $300–$800/month maintenance retainer","Document everything — recurring maintenance fees are where the real revenue is"] },
  ...
  return (
    ...
    >
      ...
      <main style={{flex:1}}>
        ...
        {view==="earn"       &&<EarnPage onNav={onNav}/>}
