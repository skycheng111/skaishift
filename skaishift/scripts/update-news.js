...
Return ONLY valid JSON (no markdown, no extra text):
{
  ...
  "hook": "<A single punchy, conversational Instagram-style sentence for the first slide. NOT a news headline — write it like a person reacting to something wild and talking to their followers. RULES: Never mention specific numbers of videos, demos, or announcements the viewer cannot see. Never say things like '9 videos' or '12 announcements'. Focus on the feeling, the impact, or the name of the product/model. Examples: 'Gemini Omni just changed everything.' or 'Google just made every other AI model nervous.' or 'This is the AI drop everyone has been waiting for.' Max 12 words. No quotes.>",
  ...
  "examples": ["<Slide 2: One specific, concrete thing this technology can DO — phrased as a demonstration, not an announcement. Like 'Drop in a reference image and get POV footage driving a taxi along the route' or 'Translate a creator's voice into Spanish while keeping the original soundtrack and mouth movements'. Visual, specific, actionable. Max 20 words.>", "<Slide 3: Another specific demonstration or capability — different from slide 2. What else can it actually do? Max 20 words.>", "<Slide 4: A third specific example, ideally showing a surprising or creative use case. Max 20 words.>"],
...
const AI_MODEL_NAMES = [
  ...
  'Midjourney V8','Midjourney V7','Midjourney',
  'Claude Fable','Claude Sonnet 5','Qwen 3.7','Kimi K2',
  'GPT-5.6','Grok 4.5','Gemini 3.6',
